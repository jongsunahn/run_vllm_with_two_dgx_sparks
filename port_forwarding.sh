...
sudo iptables -t nat -D OUTPUT -p tcp -d 192.168.0.22 --dport 8000 -j DNAT --to-destination 10.20.0.202:8000 2>/dev/null
sudo iptables -t nat -D PREROUTING -p tcp -d 192.168.0.22 --dport 8000 -j DNAT --to-destination 10.20.0.202:8000 2>/dev/null
...
sudo iptables -t nat -D OUTPUT -p tcp -d 192.168.0.22 --dport 8265 -j DNAT --to-destination 10.20.0.202:8265 2>/dev/null
sudo iptables -t nat -D PREROUTING -p tcp -d 192.168.0.22 --dport 8265 -j DNAT --to-destination 10.20.0.202:8265 2>/dev/null
...
# --- vLLM (Port 8000) 규칙 ---
sudo iptables -t nat -A PREROUTING -p tcp -d 192.168.0.22 --dport 8000 -j DNAT --to-destination 10.20.0.202:8000
sudo iptables -t nat -A OUTPUT -p tcp -d 192.168.0.22 --dport 8000 -j DNAT --to-destination 10.20.0.202:8000
...
sudo iptables -t nat -A PREROUTING -p tcp -d 192.168.0.22 --dport 8265 -j DNAT --to-destination 10.20.0.202:8265
sudo iptables -t nat -A OUTPUT -p tcp -d 192.168.0.22 --dport 8265 -j DNAT --to-destination 10.20.0.202:8265
